...
export function logToolCall(toolName: string, args: any, result: any, duration: number) {
...
export function logWordPressCall(endpoint: string, method: string, status: number, duration: number) {
...
export function logError(context: string, error: Error | any, additionalInfo?: any) {
