 ...
 */
export function createError(errorCode, message, details, context) {
 ...
 */
function getFixesForError(errorCode, details) {
    switch (errorCode) {
 ...
 */
function getTypeCastExample(receivedType, expectedType) {
 ...
 */
export function validationError(field, expected, received, blockName) {
    return createError('TYPE_MISMATCH', `Type mismatch for ${field}: expected ${expected}, received ${typeof received}`, {
        field,
        expected,
 ...
 */
export function missingFieldError(field, expected) {
    return createError('MISSING_REQUIRED_ATTR', `Missing required field: ${field}`, {
        field,
        expected,
 ...
 */
export function invalidBlockNameError(received, suggestions) {
    return createError('INVALID_BLOCK_NAME', `Invalid block name format: "${received}". Must start with "tpgb/"`, {
        received,
        expected: 'tpgb/*',
 ...
 */
export function missingBlockIdError(blockName) {
    return createError('MISSING_BLOCK_ID', `Block "${blockName}" is missing required block_id attribute`, {
        field: 'attrs.block_id',
        block_name: blockName,
 ...
 */
export function invalidBlockIdError(blockId, blockName) {
    return createError('INVALID_BLOCK_ID_FORMAT', `Invalid block_id format: "${blockId}". Must be 4-character hex (a-f, 0-9)`, {
        field: 'attrs.block_id',
        block_name: blockName,
        received: blockId,
 ...
 */
export function wordpressApiError(message, statusCode, details) {
    return createError('WORDPRESS_API_ERROR', message, {
        ...details,
